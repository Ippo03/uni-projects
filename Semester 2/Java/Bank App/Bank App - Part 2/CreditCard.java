public class CreditCard extends BankProduct {
    ...
    public CreditCard(String productCode, String customerIBAN, String customerTaxCode, 
        double commissionPercentage, double maxTransactionAmount, double maxAnnualAmount,
        String description) {
    ...
    public String toString() {
        return String.format("Key: %s, Product Code: %s, Customer Iban: %s, Customer Tax Code: %s, Commission: %.02f%% \nDescription: %s, Max Transaction Amount: %.02f EUR, Max Annual Amount: %.02f EUR",
            getKey(), getProductCode(), getCustomerIBAN(), getCustomerTaxCode(), _commissionPercentage * 100, getDescription(), getMaxTransactionAmount(), getMaxAnnualAmount());
    }
}
