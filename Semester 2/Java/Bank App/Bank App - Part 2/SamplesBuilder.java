public class SamplesBuilder {
    ...
    private void addLoans() {
        _bankProducts.add(new Loan("1", "K87363", "765432109", 100000.00, 13.00/100, "Loan 1"));
        _bankProducts.add(new Loan("2", "K78664", "765432109", 2000000.00, 15.00/100, "Loan 2"));
        _bankProducts.add(new Loan("3", "K06237", "765432109", 3300000.00, 11.00/100, "Loan 3"));
    }

    private void addCreditCards() {
        _bankProducts.add(new CreditCard("4", "K36479", "201242070", 15.00/100, 150000.00, 500000, "CC 1"));
        _bankProducts.add(new CreditCard("5", "K43023", "131242111", 12.00/100, 300000.00, 1000000, "CC 2"));
        _bankProducts.add(new CreditCard("6", "K69401", "205248573", 17.00/100, 600000.00, 5500000, "CC 3"));
    }

    private void addSales() {
        _sales.add(new Sale("12345", "1", "Consumer Loan", "Loan"));
        _sales.add(new Sale("12345", "4", "Consumer Card", "Card"));
        _sales.add(new Sale("34567", "2", "Residential Loan", "Loan"));
        _sales.add(new Sale("34567", "5", "Debit Card", "Card"));
        _sales.add(new Sale("98765", "3", "Investment Loan", "Loan"));
        _sales.add(new Sale("98765", "6", "Business Card", "Card"));
    }
